...
State monitoring uses *dynamic polling*: every second while transitioning (connecting/disconnecting), then every 5 seconds once stable. A *Custom* fixed interval can be set in *Settings* if you prefer predictable behavior.
